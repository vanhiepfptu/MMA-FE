...
import { View, Text, Button, FlatList, StyleSheet, Alert, Modal, TextInput } from "react-native";
...
function ManageProduct() {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWU4Yjc3NWMzMWY1MGM5ZTNiZWM3NDMiLCJpYXQiOjE3MDk3NTAxMzN9.cQM3-hYgTDG_59_HvNkZQ7qeSZWrWHl1aLAC699A_2I";
    ...
    const renderProduct = ({ item }) => (
        ...
        >
            ...
            <Button   title="Delete" onPress={() => deleteProduct(item.productid)} color="red"/>
            ...
            >
                <View style={styles.modalContainer}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditableProduct({ ...editableProduct, productImage: text })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditableProduct({ ...editableProduct, productPrice: text })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditableProduct({ ...editableProduct, productType: text })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditableProduct({ ...editableProduct, productQuantity: text })}
                    ...
                    <Button title="Cancel" onPress={() => setEditModalVisible(false)} style={styles.saveButton} color="#D04848" />
                    <Button title="Save" onPress={handleEditSubmit} color="#4CAF50" style={styles.saveButton_2} />
